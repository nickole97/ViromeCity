...
::: route
- [What]{.q}
  ### [What is a virus?](sections/what.qmd)
  Its anatomy, what it's made of, and the three axes we use to classify it:
  host, gene content, and state.

- [Why]{.q}
  ### [Why the virome matters](sections/why.qmd)
  Short comic-style stories of how studying viromes has shaped human health —
  evolution, ecology, medicine.

- [Where]{.q}
  ### [Where viruses hide](sections/where.qmd)
  Everywhere, but tiny. How the way you search changes across the body — and
  where the noise comes from.

- [How-to]{.q}
  ### [How to design the experiment](sections/how-to.qmd)
  Convert, enrich, sequence, analyze. What all of the above means for your
  protocol, from sampling to bioinformatics.

- [Then the tool]{.q}
  ### [Fivi's Kitchen](sections/kitchen.qmd)
  Pick your sample, your target and your experience. Fivi cooks a method plan for
  your exact case — including the times when the honest answer is
