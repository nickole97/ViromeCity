...
![The first decision, before any tool is chosen. Quality control and host removal are the same for everyone; after that the path forks by what you are after.](../assets/img/how-to/pipeline-first-fork.svg){#fig-pipeline fig-alt="A decision flow: raw sequences go through QC and host removal, then split by what you are after — phages, which fork again into integrated or free, and eukaryotic viruses, which fork by goal into genomics or detection."}
