...
::: insight
Each of those structures will shape your decisions at the bench.
:::

::: block
So when you design a protocol, go part by part: the envelope decides how the
particle survives enrichment; the capsid is what lets you digest free nucleic
acid away before lysis; and whether the genome is DNA or RNA decides the
...
::: block
Viral diversity can feel overwhelming — they are extremely diverse, fast-evolving
creatures.
:::
...
that happens to every branch. Almost every living organism has viruses inside
it. I infect bacteria; others infect archaea, and others infect you.
:::

::: block
So instead of memorizing every viral family or taxonomic group — which can
change from one month to the next — let's organize this diversity around three
questions:
:::
...
::: methodology
**Settle which host you are after before you touch the sample.** A human virome
is not only human viruses — the gut is full of bacteria, so it is full of their
phages too. Whether you are chasing eukaryotic viruses, phages or both decides
where you look, which reference you search, and how you read what comes back.
:::
...
:::
::: methodology
**RNA forks into two protocols, and it is your sample that picks which one.**
With material to spare, you deplete the ribosomal RNA that dominates it and
build the library by ligation, and the run stays quantitative. With almost
nothing to start from, you have to amplify at random before there is anything to
ligate — which buys you a library you could not otherwise build, and costs you
the abundances. The [How-to district](how-to.qmd) runs both.
:::
