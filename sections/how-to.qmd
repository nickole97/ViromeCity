...
::: research
**What this district recommends is what this laboratory does.** Every fork here
has alternatives, and a protocol that departs from ours for a stated reason is
not a worse protocol — it is how methods improve. What the district leaves out
on purpose is the merely possible: routes that work in principle but are not
standard practice. A guide that lists everything technically achievable stops
being a guide, and the reader who needed one is the reader it fails.
:::
