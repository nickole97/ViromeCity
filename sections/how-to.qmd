...
::: fig-pending
**Before and after VLP.** The stool bar from District 3, redrawn after
enrichment: the sliver becomes most of the sample. Measured at 2.4% of reads by
bulk sequencing, rising to 63–73% after enrichment.
:::
...
::: block
And there is a third route that is neither: **probe capture**, which hybridises
against a panel and recovers only what the panel already knows about.

The three are worth watching side by side, because each gate rejects things for
