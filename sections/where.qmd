...
::: insight
This is the hardest thing about sequencing a virome. You are after the smallest
thing in the sample, and the machine counts bases, not particles. Everything the
bench does about it, from filtering to digesting to enriching, is the
...
::: block
Have you ever seen a tiger at the North Pole, or a wax palm growing in
